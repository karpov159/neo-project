...
import { setBrowseAccessError, setNewClaimAccesError } from "../../claims-list/ClaimsSlice";

const ErrorAccess = ({text}) => {
    const dispatch = useDispatch(),
          {browseAccessError, newClaimAccesError} = useSelector(state => state.claims);
    ...
    return (
        <div className="error-access">
            <div onClick={onClick} className="error-access__close">×</div>
